...
best_args = {
    ...
    'seq-mnist': {
        ...
        'derpp': {200: {'lr': 0.03,
                  ...
                  5120: {'lr': 0.1,
                         ...
                         'batch_size': 10,
                         'n_epochs': 1}},
	  # Additional result 2: add buff size from 1-1e6 -- group 21
        'clser': {
            1: {
                'reg_weight': 2.0,
                'stable_model_update_freq': 0.9,
    ...
    # Additional result 1: update_freq can be changed here -- group 21
            500: {
                'reg_weight': 2.0,
                'stable_model_update_freq': 0.9,
                'stable_model_alpha': 0.99,
    ...
    # Additional result 3: add parameters for seq-cifar100 -- group 21
